...
function PaletteTile({ kind }: { kind: BlockKind }) {
  ...
  return (
    <div
      ...
      className="flex w-full min-w-[160px] cursor-grab items-start gap-2 rounded-md border border-transparent px-2 py-1.5 text-left hover:border-[var(--line)] hover:bg-[var(--panel-2)] active:cursor-grabbing"
    >
